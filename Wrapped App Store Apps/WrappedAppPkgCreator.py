...
"""See docstring for WrappedAppPkgCreator class"""
...
__all__ = ["WrappedAppPkgCreator"]


class WrappedAppPkgCreator(DmgMounter, PkgCreator):
    ...
    input_variables = {
        ...
        "app_name": {
            "required": True,
            "description": "Specify the app name that's been wrapped"
        }
    }
    output_variables = {
        "new_package_request": {
        ...
        if not self.env.get("version"):
            ...
            # Specific error if the key does not exist.
                ...
                raise ProcessorError(
                    ...
                    f"Bundle's Info.plist! ({app_path}/Wrapper/{app_name}/Info.plist) "
...
if __name__ == "__main__":
    PROCESSOR = WrappedAppPkgCreator()
